...
DEBUG_CONN_CLOSED = 'connection closed unexpectedly'
DEBUG_CLIENT_CONN_CLOSED = 'connection closed unexpectedly by client'
DEBUG_SERVER_CONN_CLOSED = 'connection closed unexpectedly by server'
DEBUG_RECV_CONN = 'got connection from {0}:{1}'
DEBUG_SEND_STOP = 'stopped sending datagrams'
DEBUG_RECV_STOP = 'stopped receiving datagrams'
...
ERR_INVALID_SEND = 'tried sending invalid datagram to id: {0}'
ERR_INVALID_RECV = 'received invalid datagram from id: {0}'
ERR_INVALID_COMMAND = 'received datagram with invalid command from id: {0}'
...
ERR_CLIENT_START = 'failed to start client'
