...
class ChatWidget(QWidget):
    ...
    def __init__(self, tab):
        ...
        self.input_widget = None # TODO Zach
    ...
    def addUser(self, *names):
        self.getTab().input_widget.text = ''
        self.getTab().widget_stack.setCurrentIndex(0)
    ...
    def appendMessage(self, message: str, timestamp: float, source: int, name: str, id_: str, loop: bool):
        ...
        if not id_:
            obj = pyarchy.core.IdentifiedObject()
            id_ = obj.id # Generate a unique ID for the message
